    ...
    <div v-if="modalOpen" class="modal-overlay" @click.self="closeModal">
      <div class="modal">
        <div class="modal-header">
          <div class="title">{{ editing.id ? 'Edit Order' : 'Add Order' }}</div>
...
.modal-header { position: relative; background: #FFF4E6; padding: 14px 18px; border-bottom: 1px solid #f1dfd1; min-height: 64px; }
